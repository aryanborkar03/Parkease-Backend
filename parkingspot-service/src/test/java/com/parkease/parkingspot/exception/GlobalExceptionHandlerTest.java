...
class GlobalExceptionHandlerTest {
    ...
    @Test
    void handleSpotNotAvailable() {
        SpotNotAvailableException ex = new SpotNotAvailableException("Not available");
        ApiResponse res = handler.handleSpotNotAvailable(ex);
        assertFalse(res.isSuccess());
        assertEquals("Not available", res.getMessage());
    }
