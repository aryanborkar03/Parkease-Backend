...
import com.parkease.payment.util.JwtUtil;
...
class JwtAuthFilterTest {
    ...
    void doFilterInternal_ValidToken() throws Exception {
        ...
        when(jwtUtil.getEmail("valid_token")).thenReturn("test@test.com");
        when(jwtUtil.getRole("valid_token")).thenReturn("DRIVER");
    ...
    void doFilterInternal_ValidTokenWithRolePrefix() throws Exception {
        ...
        when(jwtUtil.validate("valid_token")).thenReturn(true);
        when(jwtUtil.getEmail("valid_token")).thenReturn("test@test.com");
        when(jwtUtil.getRole("valid_token")).thenReturn("ROLE_DRIVER");
